	...
	<div class="container-fluid p-0 m-0">
		<div class="row p-0 m-0">
			<div class="col p-0 m-0">
				...
				<img class="img-fluid" src="https://bafthumbs-400.bodyartforms.com/<%= rsGetOrderDetails.Fields.Item("picture_400").Value %>" alt="Product photo"></a>
