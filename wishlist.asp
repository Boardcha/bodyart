...
<div class="mx-1">
	<a class="mb-2 d-block" href="/productdetails.asp?ProductID=<%=(rsGetWishlist.Fields.Item("ProductID").Value)%>">
		...
		<% 
			...
			<img class="img-fluid" src="https://bafthumbs-400.bodyartforms.com/<%= rsGetWishlist.Fields.Item("picture").Value %>" data-img-name="<%= rsGetWishlist.Fields.Item("largepic").Value %>" alt="Thumbnail">
		<% end if %>
