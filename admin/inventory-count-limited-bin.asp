...
<tr id="<%= rsGetItems.Fields.Item("ProductDetailID").Value %>">
	<td class="update-qty">
		...
		<div class="badge badge-warning"><%= rsGetItems("pre_orders") %> on hold for custom orders</div>
		<% end if %>
	</td>
	<td>
