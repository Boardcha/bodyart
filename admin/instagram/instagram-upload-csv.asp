...
Set Upload = Server.CreateObject("Persits.Upload")
    ...
    Upload.Save("C:\inetpub\wwwroot\bootstrap-svn\admin\instagram") 'LOCALHOST TESTING
    'Upload.Save("C:\inetpub\bootstrap-baf\admin\instagram")  'LIVE SERVER


    strConn = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & _
    Server.MapPath("\admin\instagram\") & ";Extended Properties=""text;HDR=Yes;FMT-Delimited"";"
    Set conn = Server.CreateObject("ADODB.Connection")
    conn.Open strConn

    x = 1
    For Each File in Upload.Files
        File.Copy "C:\inetpub\wwwroot\bootstrap-svn\admin\instagram\instagram" & x & ".csv"   'LOCALHOST
        'File.Copy "C:\inetpub\bootstrap-baf\admin\instagram\instagram" & x & ".csv"  'LIVE SERVER
        File.Delete        
