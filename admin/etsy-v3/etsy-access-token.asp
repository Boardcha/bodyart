...
' This page is used only once to grant access scopes and get the first "refresh token". Then, "etsy-refresh-token.asp" page will be used to get new tokens.
' If you delete refresh token from the DB accidently, then you need to call this page to get the first token again.
%>
