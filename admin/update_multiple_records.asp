...
rsGetInvoice.Source = "SELECT ID, shipped, customer_first, email, date_sent, UPS_tracking, USPS_tracking, shipping_type, pay_method, transactionID FROM dbo.sent_items WHERE ID = " & varID(x) & ""
