...
function processPayment(paymentData) {
  return new Promise(function(resolve, reject) {
    setTimeout(function() {
      ...
      shipping_address1 = paymentData.shippingAddress.address1;
      shipping_address2 = paymentData.shippingAddress.address2;
      shipping_address3 = paymentData.shippingAddress.address3;
      shipping_city = paymentData.shippingAddress.locality;
      shipping_state_province = paymentData.shippingAddress.administrativeArea;
      shipping_zip = paymentData.shippingAddress.postalCode;
      shipping_country = paymentData.shippingAddress.countryCode;
      shipping_phone = paymentData.shippingAddress.phoneNumber;
          ...
          method: "post",
          dataType: "json",
          url: "google-pay/ajax-process-googlepay-card.asp",
          data: {paymentToken: paymentToken, customer_name: customer_name, shipping_address1: shipping_address1}
          })
          ...
          .fail(function(json, msg) {
            ...
            console.log(window.btoa(paymentToken));
          })  // END send payment data to authorize.net to process
