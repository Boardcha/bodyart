...
' mailer_type | mail_to_email | mail_to_name | mail_subject | mail_body 
	...
	if mailer_type = "new account" then 'newly created customer account
		...
		If google_signin_email <> "" Then mail_to_email = google_signin_email Else mail_to_email = request.form("e-mail")
	...
	if mailer_type = "notify waiting list" then 'notify customers that items are back in stock from the admin
		...
		mail_body = "You asked us to tell you when the " & rsGetCustomers.Fields.Item("item_name").Value & " would be back in stock for ordering.<br><br>We are pleased to tell you it is now available. We only have a limited amount, and this email is not a guarantee you'll get one. So hurry to <a href=http://www.bodyartforms.com/productdetails.asp?ProductID=" & rsGetCustomers.Fields.Item("ProductID").Value & ">BAF</a> and make sure you get yours now!<br><br><div style=""background-color: #404064; padding: .4em 0; width:120px; font-weight: bold; text-align: center;""><a href=http://www.bodyartforms.com/productdetails.asp?ProductID=" & rsGetCustomers.Fields.Item("ProductID").Value & " style=""text-decoration: none; color: #B8B8E6 !important;"">BUY NOW</a></div><a href=http://www.bodyartforms.com/productdetails.asp?ProductID=" & rsGetCustomers.Fields.Item("ProductID").Value & "><img src=http://bafthumbs-400.bodyartforms.com/" & rsGetCustomers.Fields.Item("picture").Value & " width=120px height=120px></a><div style=""padding: 1em 0"">Happy Shopping,<br><br>Your friends at Bodyartforms</div><div style=""padding: 2em 0 0 0; font-size: .9em;"">P.S. If you arrive at the site, and the item is already sold out, we are sorry! But, at least you know you have great taste :)</div>"
