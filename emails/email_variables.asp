...
' mailer_type | mail_to_email | mail_to_name | mail_subject | mail_body 
	...
	if mailer_type = "notify-photography" then ' notify photography of bad review
		...
		cc1_name = "Nathan"
		cc1_email = "nathan@bodyartforms.com"
		cc2_name = "Melissa"
		cc2_email = "melissa@bodyartforms.com"
		cc3_name = "Jackie"
		cc3_email = "jackie@bodyartforms.com"
