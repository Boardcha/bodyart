...
<div class="container-fluid">
	<div class="col-12 mb-2 bg-secondary text-white rounded" style="font-size:1.5em">
		Owners / Founders
	</div>
	<div class="row text-center py-3">
		<div class="col-6">
				<img class="img-fluid" src="images/employees/amanda-circle.png" alt="Amanda" />
				<h5>Amanda</h5>
		</div>
		<div class="col-6">
			<img class="img-fluid" src="images/employees/ellen-circle.png" alt="Ellen" />
			<h5>Ellen</h5>  
		</div>
	</div>
	...
	<div class="row text-center py-3">
		<div class="col-6">
			<img class="img-fluid" src="images/employees/empty-avatar.png" alt="Heather" />
			<h5>Heather</h5>
		</div>
		<div class="col-6">
	...
	<div class="row text-center py-3">
		<div class="col-6">
			<img class="img-fluid" src="images/employees/empty-avatar.png" alt="Shalysha" />
			<h5>Shalysha</h5>
		</div>
	</div>
...
<div class="col-12 mb-2 bg-secondary text-white rounded mt-5" style="font-size:1.5em">
	Company History
</div>
<p>	 
