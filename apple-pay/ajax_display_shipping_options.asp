	...
	If country_code <> "" Then
		...
		While NOT rsGetShippingOptions.EOF 
			If rsGetShippingOptions("ShippingName").Value <> "ONLY gift certificate" Then
				i = i + 1
				options = options & "{""label"": """ & rsGetShippingOptions("ShippingName") & """, ""amount"": " & rsGetShippingOptions("price") & ", ""detail"": """ & rsGetShippingOptions("ShippingDesc_Public") & """, ""identifier"": """ & rsGetShippingOptions("IDShipping") & """},"
