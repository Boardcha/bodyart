...
invoiceid = request.form("id")
	...
	objCmd.CommandText = "SELECT * FROM sent_items WHERE ID = ? AND ship_code = 'paid' AND (shipped = 'Pending...' OR shipped = 'Pending shipment' OR shipped = 'Review' OR shipped = 'PRE-ORDER REVIEW')"
