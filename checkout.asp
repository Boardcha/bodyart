...
<div class="form-group position-relative">
	...
	<input class="form-control" required type="text" name="cvv2" id="security-code" data-friendly-error="Billing address: Security code is required">
	<div class="invalid-feedback">
		...
		<div class="sticky-top" style="z-index:100">
			<div class="card bg-light mb-2">
				<div class="card-body text-left py-2">
					...
					%>
					<%
					If request.querystring("type") = "afterpay" AND (var_grandtotal < 35 Or var_grandtotal > 2000) Then
						afterpay_display = "display:none"%>
...
<script type="text/javascript" src="/js-pages/cart.min.js?v=072722" async></script>
<script type="text/javascript" src="/js-pages/checkout.min.js?v=072722"></script>
