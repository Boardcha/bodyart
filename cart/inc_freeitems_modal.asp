...
' ------- Get FREE o-rings
		...
		objCmd.CommandText = "SELECT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.ProductID, jewelry.title, ProductDetails.ProductDetailID, ProductDetails.qty, ProductDetails.ProductDetail1, ProductDetails.Gauge, jewelry.picture, ProductDetails.detail_code, ProductDetails.Free_QTY, ProductDetails.free " & _
							...
							"WHERE (jewelry.ProductID = 530 OR (jewelry.ProductID = 1649 AND ProductDetails.Gauge <> '1-1/8" & """" & "') OR jewelry.ProductID = 15385) AND ProductDetails.qty > 0 ORDER BY title, item_order ASC"
...
<% var_viewcart_showgifts = "yes" %>
		...
		<div class="form-group form-check form-check-inline mt-3">
			<label class="form-check-label-gauge" for="gaugeCardCheck">
				<input type="checkbox" class="form-check-input" id="gaugeCardCheck" <%if request.cookies("gaugecard") <> "no" then %> checked<%end if%>>
				 Gauge card
			</label>  
		</div>				
...
' ------- Get FREE items for TIER 1 (ORINGS)
		...
		objCmd.CommandText = "SELECT DISTINCT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.title, jewelry.picture,jewelry.ProductID, jewelry.picture, CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END " & _
							"FROM ProductDetails INNER JOIN jewelry ON ProductDetails.ProductID = jewelry.ProductID " & _ 
							"INNER JOIN FlatProducts ON FlatProducts.ProductID = jewelry.ProductID " & _ 
							"WHERE ProductDetails.free <= 30 AND (jewelry.ProductID = 530 OR (jewelry.ProductID = 1649 AND ProductDetails.Gauge <> '1-1/8" & """" & "') OR jewelry.ProductID = 15385) " & _
...
' ------- Get FREE items for TIER 3
		...
		objCmd.CommandText = "SELECT DISTINCT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.title, jewelry.picture,jewelry.ProductID, jewelry.picture, CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END " & _
							"FROM ProductDetails INNER JOIN jewelry ON ProductDetails.ProductID = jewelry.ProductID " & _ 
							"INNER JOIN FlatProducts ON FlatProducts.ProductID = jewelry.ProductID " & _ 
							"WHERE ProductDetails.free <= 30 AND (jewelry.ProductID <> 3928) AND (jewelry.ProductID <> 1430) AND (jewelry.ProductID <> 3704) AND (ProductDetails.qty > 0) AND (ProductDetails.free <> 0) AND (ProductDetails.free IS NOT NULL) AND (ProductDetails.active = 1) " & _
							"ORDER BY CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END, jewelry.title"
		  ...
		  <div class="card" style="overflow: visible;">
			...
			<div class="card-header" role="tab" id="headingThree3">
			  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
				...
				<div class="d-inline-block">
				<h5 class="mb-0">
				 <%If free_items_count < 3 Then %><i class="fa fa-lock"></i><%End If%> $30.00 CART THRESHOLD <i class="fas fa-angle-down rotate-icon"></i>
				</h5>
				</div>
...
' ------- Get FREE items for TIER 4
		...
		objCmd.CommandText = "SELECT DISTINCT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.title, jewelry.picture,jewelry.ProductID, jewelry.picture, CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END " & _
							"FROM ProductDetails INNER JOIN jewelry ON ProductDetails.ProductID = jewelry.ProductID " & _ 
							"INNER JOIN FlatProducts ON FlatProducts.ProductID = jewelry.ProductID " & _ 
							"WHERE ProductDetails.free <= 50 AND (jewelry.ProductID <> 3928) AND (jewelry.ProductID <> 1430) AND (jewelry.ProductID <> 3704) AND (ProductDetails.qty > 0) AND (ProductDetails.free <> 0) AND (ProductDetails.free IS NOT NULL) AND (ProductDetails.active = 1) " & _
							"ORDER BY CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END, jewelry.title"
		  ...
		  <div class="card" style="overflow: visible;">
			...
			<div class="card-header" role="tab" id="headingThree4">
			  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
				...
				<div class="d-inline-block">
				<h5 class="mb-0">
				 <%If free_items_count  < 4 Then %><i class="fa fa-lock"></i><%End If%> $50.00 CART THRESHOLD <i class="fas fa-angle-down rotate-icon"></i> 
				</h5>
				</div>
...
' ------- Get FREE items for TIER 5
		...
		objCmd.CommandText = "SELECT DISTINCT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.title, jewelry.picture,jewelry.ProductID, jewelry.picture, CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END " & _
							"FROM ProductDetails INNER JOIN jewelry ON ProductDetails.ProductID = jewelry.ProductID " & _ 
							"INNER JOIN FlatProducts ON FlatProducts.ProductID = jewelry.ProductID " & _ 
							"WHERE ProductDetails.free <= 75 AND (jewelry.ProductID <> 3928) AND (jewelry.ProductID <> 1430) AND (jewelry.ProductID <> 3704) AND (ProductDetails.qty > 0) AND (ProductDetails.free <> 0) AND (ProductDetails.free IS NOT NULL) AND (ProductDetails.active = 1) " & _
							"ORDER BY CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END, jewelry.title"
		  ...
		  <div class="card" style="overflow: visible;">
			...
			<div class="card-header" role="tab" id="headingThree5">
			  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
				...
				<div class="d-inline-block">
				<h5 class="mb-0">
				  <%If free_items_count < 5 Then %><i class="fa fa-lock"></i><%End If%> $75.00 CART THRESHOLD <i class="fas fa-angle-down rotate-icon"></i>
				</h5>
				</div>
...
' ------- Get FREE items for TIER 6
		...
		objCmd.CommandText = "SELECT DISTINCT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.title, jewelry.picture,jewelry.ProductID, jewelry.picture, CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END " & _
							"FROM ProductDetails INNER JOIN jewelry ON ProductDetails.ProductID = jewelry.ProductID " & _ 
							"INNER JOIN FlatProducts ON FlatProducts.ProductID = jewelry.ProductID " & _ 
							"WHERE ProductDetails.free <= 100 AND (jewelry.ProductID <> 3928) AND (jewelry.ProductID <> 1430) AND (jewelry.ProductID <> 3704) AND (ProductDetails.qty > 0) AND (ProductDetails.free <> 0) AND (ProductDetails.free IS NOT NULL) AND (ProductDetails.active = 1) " & _
							"ORDER BY CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END, jewelry.title"
		  ...
		  <div class="card" style="overflow: visible;">
			...
			<div class="card-header" role="tab" id="headingThree6">
			  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree6"
				...
				<div class="d-inline-block">
				<h5 class="mb-0">
				 <%If free_items_count  < 6 Then %><i class="fa fa-lock"></i><%End If%> $100.00 CART THRESHOLD <i class="fas fa-angle-down rotate-icon"></i>
				</h5>
				</div>
...
' ------- Get FREE items for TIER 7
		...
		objCmd.CommandText = "SELECT DISTINCT FlatProducts.min_gauge, FlatProducts.max_gauge, jewelry.title, jewelry.picture,jewelry.ProductID, jewelry.picture, CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END " & _
							"FROM ProductDetails INNER JOIN jewelry ON ProductDetails.ProductID = jewelry.ProductID " & _ 
							"INNER JOIN FlatProducts ON FlatProducts.ProductID = jewelry.ProductID " & _ 
							"WHERE ProductDetails.free <= 150 AND (jewelry.ProductID <> 3928) AND (jewelry.ProductID <> 1430) AND (jewelry.ProductID <> 3704) AND (ProductDetails.qty > 0) AND (ProductDetails.free <> 0) AND (ProductDetails.free IS NOT NULL) AND (ProductDetails.active = 1) " & _
							"ORDER BY CASE WHEN jewelry.ProductID = 2890 THEN '1' ELSE jewelry.ProductID END, jewelry.title"
		  ...
		  <div class="card" style="overflow: visible;">
			...
			<div class="card-header" role="tab" id="headingThree7">
			  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree7"
				...
				<div class="d-inline-block">
				<h5 class="mb-0">
				  <%If free_items_count  < 7 Then %><i class="fa fa-lock"></i><%End If%> $150.00 CART THRESHOLD <i class="fas fa-angle-down rotate-icon"></i>
				</h5>
				</div>
