<%
if Request.ServerVariables("REMOTE_HOST") <> "75.109.218.250" and Request.ServerVariables("REMOTE_HOST") <> "75.109.218.58" and Request.ServerVariables("REMOTE_HOST") <> "70.114.165.125" and Request.ServerVariables("REMOTE_HOST") <> "127.0.0.1"  then ' exclude georgetown and localhost ip address
