...
' exclude georgetown and localhost ip address
if remote_ip <> "::1" and remote_ip <> "75.109.218.250" and remote_ip <> "75.109.218.58" and remote_ip <> "70.114.165.125" and remote_ip <> "127.0.0.1" _
